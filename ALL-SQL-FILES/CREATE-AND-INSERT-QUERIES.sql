...
-- TABLE CREATION PROCEDURE
    ...
    execute insrt_annual_rate(1,TO_DATE('2021/04/25', 'yyyy/mm/dd'),1);
    execute insrt_annual_rate(7,TO_DATE('2021/04/26', 'yyyy/mm/dd'),1);
    execute insrt_annual_rate(16,TO_DATE('2021/04/27', 'yyyy/mm/dd'),1);
    execute insrt_annual_rate(17,TO_DATE('2021/04/28', 'yyyy/mm/dd'),1);
    execute insrt_annual_rate(18,TO_DATE('2021/04/29', 'yyyy/mm/dd'),1);
    execute insrt_annual_rate(17,TO_DATE('2021/04/30', 'yyyy/mm/dd'),1);
    execute insrt_annual_rate(14,TO_DATE('2021/05/01', 'yyyy/mm/dd'),1);
    execute insrt_annual_rate(5,TO_DATE('2021/08/15', 'yyyy/mm/dd'),1);
    execute insrt_annual_rate(12,TO_DATE('2022/01/31', 'yyyy/mm/dd'),1);
    execute insrt_annual_rate(10,TO_DATE('2019/10/10', 'yyyy/mm/dd'),1);
    execute insrt_annual_rate(1,TO_DATE('2021/04/25', 'yyyy/mm/dd'),2);
    execute insrt_annual_rate(8,TO_DATE('2021/04/26', 'yyyy/mm/dd'),2);
     execute insrt_annual_rate(17,TO_DATE('2021/04/27', 'yyyy/mm/dd'),2);
    execute insrt_annual_rate(16,TO_DATE('2021/04/28', 'yyyy/mm/dd'),2);
    execute insrt_annual_rate(17,TO_DATE('2021/04/29', 'yyyy/mm/dd'),2);
    execute insrt_annual_rate(16,TO_DATE('2021/04/30', 'yyyy/mm/dd'),2);
    execute insrt_annual_rate(14,TO_DATE('2021/05/01', 'yyyy/mm/dd'),2);
